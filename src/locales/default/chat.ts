export default {
  ...
  'claudeCodeInstallGuide.reason': 'nexumChat could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'nexumChat could not start Codex: {{message}}',
  ...
  'plus.search.appSearchDesc':
    'nexumChat optimized search service, delivering best retrieval results.',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of nexumChat. nexumChat is not responsible for any consequences arising from this shared content.',
